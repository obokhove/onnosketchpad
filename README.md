...
Try a=10 but still b =10*dt^(3/2), lambda = -a*exp(-gam*Z/b):
...
4th 4 min
5th 7.34 min
<img width="468" height="152" alt="image" src="https://github.com/user-attachments/assets/0055d3bc-1e40-43c7-bbc0-5ff0daa6e388" />

...
if nwave==1:
    ...
    # Use non-sinh form! 10-03-2026:
    # Use non-sinh form! 10-03-2026: Forcingterm = ggrav*fd.exp(cc*(Keel+tanalp*(x[1]-Ly)))*fd.conditional(fd.eq(deltacons,0.0),fd.exp(-0.5*cc*(Zn-hn+Z0-h0)),ccinv*(fd.exp(-cc*(Zn-hn))-fd.exp(-cc*(Z0-h0)))/deltacons)

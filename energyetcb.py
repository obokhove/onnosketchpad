...
# adata_path='/Users/onnobokhove/amtob/werk/vuurdraak2021/wavenergy2025/' /Users/amtob/werkvuurdraak2025/wavenenergy2025
adata_path='/Users/amtob/werkvuurdraak2025/wavenenergy2025/'

# fileEdata = np.array([[ t, Z00[0], W00[0], I00[0], E0, E1 ]])
fileEZWI = adata_path +'data58/VBMZWIenergy.csv' # 

save_figure=True
figure_name_1='energyCG10304.png'
figure_name_2='compZWIECG10304.png'

with open(fileEZWI,'r') as MMP1:
    t1_MMP, E1_tot_MMP = np.loadtxt(MMP1, usecols=(0,1), unpack=True)

save_figure = True
figure_name = 'energy_panelsCG10304.png'

...
if nvpcase=="AVFvector":
    ...
    result_mixedmp = fd.Function(mixed_Vmp)
    vvmp = fd.TestFunction(mixed_Vmp)
    vvmp0, vvmp3, vvmp4, vvmp5 = fd.split(vvmp) # These represent "blocks".
...
#
#
wavebuoy_nl = fd.NonlinearVariationalSolver(fd.NonlinearVariationalProblem(F_exprnl, result_mixedmp), solver_parameters=solver_parameters5)
...
# Set tolerances directly on the SNES object snes.setTolerances(rtol=1e-16, atol=1e-16)

...
#outfile_Zn = VTKFile(os.path.join(save_path, "Wn.pvd"))
#outfile_Wn = VTKFile(os.path.join(save_path, "Zn.pvd"))
fileE = save_path+"VBMpsienergy.txt"
...
while t <= 1.0*(t_end + dt):
    ...
    if (t in t_plot): # Plotting # print('Plotting starts')
        ...
        #outfile_Zn.write(Z1, time=t)
        #outfile_Wn.write(W1, time=t)
